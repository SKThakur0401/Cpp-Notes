// WAS DIFFICULT TO SOLVE IN THE FIRST TIME...
// BRUTE FORCE APPROACH IS NOT TOUGH...BUT IT GIVES A TIME COMPLEXITY --->  O(n^2) ;
// THE SOLUTION BELOW HAS A TIME COMPLEXITY---> O(n)  and space complexity ---> O(n)
// ON THE FIRST LOOK U WOULDN'T REALISE THE TIME COMP. IS O(n)
// TRY IT URSELF...
